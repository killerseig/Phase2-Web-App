...
- Firestore Rules and Storage Rules now include an initial target-role bridge for active app access, employee management, job read/create/update/delete boundaries, shop catalog management, timecard read/delete access, assigned Project Manager submitted-timecard viewing, field workflow access, and daily-log attachment read access.
