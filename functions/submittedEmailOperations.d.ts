...
export declare function claimSubmittedEmailOperation(db: admin.firestore.Firestore, refs: admin.firestore.DocumentReference[], operationId: string, context: Record<string, unknown>): Promise<SubmittedEmailOperationClaimStatus>;
