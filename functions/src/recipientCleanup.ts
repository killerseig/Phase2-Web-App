...
export async function removeEmailFromRecipientLists(
  ...
  if (settingsSnap.exists) {
    ...
    const globalRecipients =
      typeof data.globalNotificationRecipients === 'object' &&
    ...
    const nextGlobalFieldUserAssignments = filterRecipientList(
      globalRecipients.fieldUserAssignments,
    )
  ...
  jobsSnap.docs.forEach((jobDoc) => {
    ...
    const notificationRecipients =
      typeof data.notificationRecipients === 'object' && data.notificationRecipients !== null
