import { ref } from 'vue'
import { useAdminCatalogEditing } from '@/views/admin/useAdminCatalogEditing'
import { useAdminCatalogLifecycleActions } from '@/views/admin/useAdminCatalogLifecycleActions'
import type { AdminCatalogMutationState, UseAdminCatalogMutationsOptions } from '@/views/admin/adminCatalogMutationTypes'

export type { ConfirmFn, UseAdminCatalogMutationsOptions } from '@/views/admin/adminCatalogMutationTypes'
