...
defineProps<{
  loadError: string
  pagedCards: readonly (readonly TimecardPdfExportCard[])[]
  payload: TimecardPdfExportPayload | null
  triggerPrint: () => unknown
}>()
</script>
  ...
  <div class="timecard-print-view" data-testid="timecard-export-print-page">
    <header v-if="payload" class="timecard-print-view__screen-toolbar">
      <div class="timecard-print-view__screen-copy">
        ...
        <span>Generated {{ formatTimecardPrintGeneratedAt(payload.generatedAt) }}</span>
      </div>
